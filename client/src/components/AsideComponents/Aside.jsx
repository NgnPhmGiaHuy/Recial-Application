...
const Aside = () => {
    ...
    const showLessAsideFollowItem = useCallback((value) => {
    ...
    const showLessAsideNavigationItem = useCallback((value) => {
                                ...
                                <section>
                                    <ul>
                                        {asideNavigationItemList.slice(0, asideNavigationItemsToShow).map((value, index) => (
                                            <AsideItem key={index} asideItemData={value}/>
                                        ))}
                                    </ul>
                                    {asideNavigationItemsToShow === asideNavigationItemList.length ? (
                                        <AsideShowMoreOrShowLessButton showMore={false} onClick={() => showLessAsideNavigationItem(asideNavigationItemList)}/>
                                    ) : (
                                                            ...
                                                            <span className="block text-[16px] text-zinc-500 text-left font-bold break-words leading-5">
                                                                <div className="flex flex-row flex-nowrap items-center justify-between relative">
                                                                    <div className="flex flex-col flex-shrink grow relative">
                                                                        <h3 className="block text-[16px] text-zinc-500 text-left font-bold break-words leading-5">
