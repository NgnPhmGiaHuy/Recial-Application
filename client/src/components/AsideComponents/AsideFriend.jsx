...
const AsideFriend = ({asideFriendTitle, asideFriendSubtitle, asideFriendRequest, asideFriendList, userProps}) => {
    return (
                        ...
                        {userProps && asideFriendList ? (
                            <section>
                                <div className="py-[16px] mx-[8px]">
                                    <label htmlFor="session_search_friends" className="w-full min-w-[40px] min-h-[36px] flex items-stretch rounded-full outline-none bg-zinc-100 relative">
                                        ...
                                        <input type="text" name="session_search_friends" placeholder="Search friends" className="h-[36px] px-[6px] pt-[7px] pb-[9px] flex flex-shrink grow basis-auto text-[15px] text-black text-left font-normal rounded-r-full outline-none bg-transparent relative"/>
                                    </label>
                                </div>
                            </section>
                        ) : null}
                            ...
                            {userProps && asideFriendRequest ? (
                                        ...
                                        <div className="pb-[4px] pt-[20px] px-[8px] flex flex-col relative">
                                            <div className="flex flex-col grow relative">
                                                <span className="block text-[17px] text-black text-left font-semibold break-words leading-5 relative">
                                                    <span className="overflow-x-hidden overflow-y-hidden relative">
                                                        {userProps.friend_requests.length + " " + asideFriendTitle}
                                                    </span>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div className="mb-[5px] mt-[-8px]">
                                        <div className="pb-[4px] pt-[20px] px-[8px] flex flex-col relative">
                                            <div className="flex flex-col grow relative">
                                                <span className="block text-[17px] text-black text-left font-semibold break-words leading-5 relative">
                                                    <span className="overflow-x-hidden overflow-y-hidden relative">
                                                        {userProps.friends_list.length + " " + asideFriendTitle}
                                                    </span>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <ul>
                                    {asideFriendItemList.map((value, index) => (
                                        <AsideFriendItem key={index} userProps={value}/>
                                    ))}
                                </ul>
                            )}
                        </section>
