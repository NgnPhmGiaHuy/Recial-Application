import {AsideFriendItem, FriendListItem, FriendRequestItem} from "@/components";
import {asideFriendItemList} from "@/constants/AsideConstants";

const AsideFriend = ({asideFriendTitle, asideFriendSubtitle, asideFriendRequest, asideFriendList, userData}) => {
    return (
                    ...
                    <div className="flex flex-col grow relative">
                        <div className="mt-[16px] p-[8px] flex flex-col grow relative">
                            <div className="flex flex-col relative">
                                ...
                                {userData && asideFriendList ? (
                                    <section>
                                            <div className="py-[16px] mx-[8px]">
                                                <label htmlFor="" className="w-full min-w-[40px] min-h-[36px] flex items-stretch rounded-full outline-none bg-zinc-100 relative">
                                                    ...
                                                    <input type="text" placeholder="Search friends" className="h-[36px] px-[6px] pt-[7px] pb-[9px] flex flex-shrink grow basis-auto text-[15px] text-black text-left font-normal rounded-r-full outline-none bg-transparent relative"/>
                                                </label>
                                            </div>
                                    </section>
                                ) : ""}
                                    ...
                                    {userData && asideFriendRequest ? (
                                        <>
                                                ...
                                                <div className="pb-[4px] pt-[20px] px-[8px] flex flex-col relative">
                                                    <div className="flex flex-col grow relative">
                                                        <span className="block text-[17px] text-black text-left font-semibold break-words leading-5 relative">
                                                            <span className="overflow-x-hidden overflow-y-hidden relative">
                                                                {userData.friend_requests.length + " " + asideFriendTitle}
                                                            </span>
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="px-[8px]">
                                                {userData.friend_requests.map((value, index) => (
                                            ...
                                            <>
                                                <div className="mb-[5px] mt-[-8px]">
                                                    <div className="pb-[4px] pt-[20px] px-[8px] flex flex-col relative">
                                                        <div className="flex flex-col grow relative">
                                                            <span className="block text-[17px] text-black text-left font-semibold break-words leading-5 relative">
                                                                <span className="overflow-x-hidden overflow-y-hidden relative">
                                                                    {userData.friends_list.length + " " + asideFriendTitle}
                                                                </span>
                                                            </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="px-[8px]">
                                                    {userData.friends_list.map((value, index) => (
                                                        <FriendListItem key={index} userData={value}/>
                                                    ))}
                                                </div>
                                            </>
                                        ) : (
                                        <ul>
                                            {asideFriendItemList.map((value, index) => (
                                                <AsideFriendItem key={index} asideItemData={value}/>
                                            ))}
                                        </ul>
                                        )
                                    }
