...
const AuthHeader = () => {
    return (
        <nav className="max-w-[1280px] m-auto sm:px-[60px] px-[20px] pt-[12px] pb-[16px] flex flex-nowrap items-center justify-between">
            <a href="" className="mr-auto text-lime-500 font-bold z-50">
            ...
            <ul className="mr-1 sm:flex hidden flex-row items-center justify-center after:!h-[37px] after:w-[1px] after:flex after:items-center after:bg-zinc-500">
                <li>
                    <a href="" className="w-[64px] h-[52px] mx-[8px] flex flex-col items-center justify-center text-gray-500 hover:text-black transition-all">
                        <i>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 20 17" focusable="false" aria-busy="false">
                ...
                <li>
                    <a href=""
                       className="w-[64px] h-[52px] mx-[8px] flex flex-col items-center justify-center text-gray-500 hover:text-black transition-all">
                        <i>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" focusable="false" aria-busy="false">
                ...
                <li>
                    <a href=""
                       className="w-[64px] h-[52px] mx-[8px] flex flex-col items-center justify-center text-gray-500 hover:text-black transition-all">
                        ...
                        <span className="text-[12px] text-center font-normal leading-normal">Learing</span>
                    </a>
                </li>
            </ul>
            <div className="min-w-[100px] flex flex-nowrap flex-shrink-0 justify-end gap-x-1">
                <a href="/auth/register" className="min-h-[48px] h-min px-[24px] py-[12px] text-[16px] font-semibold leading-normal text-center text-gray-500 rounded-3xl hover:bg-zinc-100 hover:text-gray-700 transition-all duration-500">Join now</a>
                <a href="/auth/login" className="min-h-[48px] h-min px-[24px] py-[12px] text-[16px] bg-white border border-solid border-lime-500 font-semibold leading-normal text-center text-lime-500 rounded-3xl hover:border-lime-700 hover:text-lime-700 hover:bg-lime-50 transition-all duration-500">Sign in</a>
            </div>
        </nav>
    );
};
