    ...
    return (
        <>
            <div className={`${isSignup ? "bg-white items-center justify-center" : null} p-[28px] flex flex-col rounded-[40px]`}>
                <div>
                    <div className={`${isLogin ? "sm:text-[56px]" : null} ${isSignup ? "sm:text-[46px]" : null} text-[40px] text-amber-400 font-extralight sm:leading-[67px] leading-[50px]`}>
                    ...
                    <form onSubmit={action}>
                        <div className="flex flex-col">
                            <div className="my-[12px] flex flex-col items-start relative">
                                <div className="text-[14px] text-black font-normal leading-normal">
                            ...
                            {error && error.isEmailError && error.formErrorStatus ? (
                                <div className="my-[2px] flex flex-row items-center">
                                    ...
                                    <div className="ml-[8px] flex items-center relative">
                                        <span className="text-[14px] text-red-500 text-left font-normal break-words relative leading-5">
                                            <span>
                            ...
                            {isLogin ? (
                                <div className="w-full my-[16px] flex flex-row items-center justify-start">
                                    <div className="flex flex-row">
                                        <div className="text-[16px] text-lime-500 font-semibold hover:text-lime-700 leading-5 transition-all">
                            ...
                            <div className="mx-[4px] my-[8px] flex items-center justify-center">
                                <button type="submit" className="w-full h-[54px] px-[24px] py-[12px] text-base text-white font-bold bg-lime-500 rounded-full hover:bg-lime-700 transition-all">
