import { IconButton, ImageIcon, MediumFollowButton } from "@/components";
                ...
                <div className="flex flex-row flex-shrink flex-nowrap items-center justify-between relative">
                    <div className="flex flex-col flex-shrink-0 relative">
                        <div className="max-w-[600px]">
                            <span className="block text-[28px] text-black text-left font-bold break-words relative leading-6">
                                Climate Science Center
                            </span>
                        </div>
                    </div>
                    <div className="flex flex-col flex-shrink-0 relative">
                        <ImageIcon src={ClimateIcon01} width={72} height={72} />
                    </div>
                </div>
