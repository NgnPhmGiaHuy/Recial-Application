...
const CreateGroupAside = ({ state, handleState, createGroupActionRef }) => {
    return (
                    ...
                    <div className="mt-[16px] p-[8px] flex flex-col grow relative">
                        ...
                        <div className="flex flex-col flex-shrink grow relative">
                            <div className="flex flex-col grow relative">
                                ...
                                <CreateGroupAsideForm state={state} handleState={handleState} createGroupActionRef={createGroupActionRef}/>
                            </div>
                        </div>
