                                        ...
                                        <div className="my-[-5px] flex flex-col relative">
                                            ...
                                            <div>
                                                <span className="block text-[15px] text-zinc-700 text-left font-normal break-words relative leading-5">
                                                    <span className="overflow-hidden relative">
                                                        {state.groupPrivacy.toLowerCase() === "public" ? "Anyone can see who's in the group and what they post." : "Only members can see who's in the group and what they post."}
                                                    </span>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div className="py-[12px] flex flex-col flex-shrink grow items-stretch justify-between basis-0 relative">
                                        <div className="my-[-5px] flex flex-col relative">
                                            ...
                                            <div>
                                                <span className="block text-[15px] text-zinc-700 text-left font-normal break-words relative leading-5">
                                                    <span className="overflow-hidden relative">
                                                        {state.groupVisible.toLowerCase() === "visible" ? "Anyone can find this group." : "This group is not discoverable by everyone."}
                                                    </span>
                                                </span>
                                            </div>
                                        </div>
