    ...
    return (
        <div className="m-[2px]">
            <div className="inline-flex flex-row items-stretch cursor-pointer relative">
                <div className="w-[36px] h-[36px] flex items-center justify-center rounded-full relative bg-transparent hover:bg-zinc-100" onClick={createPostContentCustomizationData.onClick}>
