...
const GroupScaffoldJoinItem = ({ groupProps }) => {
    return (
        <div className="max-w-[340px] min-w-[320px] p-[4px] flex flex-col flex-shrink grow basis-0 relative">
            <div className="p-[16px] flex flex-col justify-between bg-white shadow-[0px_0px_0px_1px_rgb(140_140_140/0.2)] rounded-md relative">
                <div className="flex flex-row items-center justify-between relative">
                    <div className="mr-[16px]">
                        <Link href={`/groups/${groupProps?._id}/`}>
                            <div className="w-[80px] h-[80px] flex flex-col rounded-md overflow-hidden relative">
                ...
                <div className="min-w-[110px] h-[40px] mt-[16px] flex items-center justify-between relative">
                    <Link href={`/groups/${groupProps?._id}/`} className="w-full flex flex-col justify-center relative">
                        <div className="h-[36px] px-[12px] flex flex-row flex-nowrap flex-shrink-0 items-center justify-center rounded-md text-lime-800 bg-lime-100 hover:bg-lime-200 transition-all">
                    ...
                    <div className="ml-[8px] flex items-center relative">
                        <div className="h-[36px] px-[16px] flex flex-row items-center justify-center rounded-md cursor-pointer bg-zinc-100 hover:bg-zinc-200 relative transition-all">
