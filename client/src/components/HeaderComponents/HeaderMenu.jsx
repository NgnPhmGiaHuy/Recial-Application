    ...
    return (
        <div className="w-screen h-screen mt-[56px] fixed top-0 left-0 bg-black/75 z-50">
            <div ref={forwardedRef}
                 className={`w-[380px] h-[calc(100vh-56px)] max-w-full max-h-screen absolute top-0 right-0 flex flex-col rounded-md bg-white shadow-lg border border-solid border-black transform-none overflow-hidden animate-movePanelRightToLeft`}>
                <div
                    className="flex flex-row py-[8px] pl-[12px] pr-[48px] items-center justify-between text-black font-normal break-words leading-5 relative">
                    <div className="text-[20px] font-semibold leading-6">
                        <h1>Menu</h1>
                    </div>
                    <div
                        className="w-[32px] h-[32px] absolute top-[8px] right-[8px] flex flex-col items-center justify-center overflow-hidden">
                        <button type="button"
                                className="w-full h-full flex flex-row items-center justify-center rounded-full hover:bg-zinc-200 transition-all"
                ...
                <div className="min-h-[5.6rem] flex flex-col px-[12px] py-[8px] overflow-auto">
                    <section
                        className="mt-[12px] bg-white border border-solid border-gray-200 rounded-xl overflow-visible relative">
