        ...
        <div className="ml-[12px] flex items-center justify-start">
            <div className="h-[24px] overflow-x-auto overflow-y-auto inline-block relative">
                <div className="w-[44px] h-[24px] rounded-xl relative overflow-hidden">
                    ...
                    <div className={`${isHeaderMessageSwitchButtonChecked ? "transform translate-x-5" : ""} w-[20px] h-[20px] top-[2px] left-[2px] absolute rounded-full z-10 bg-white shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] transition-all duration-300 ease-in-out`}></div>
                </div>
