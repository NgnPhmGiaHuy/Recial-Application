...
import { fakeNotificationData, headerNotificationQuickSettingList } from "@/constants/HeaderConstants";
import { HeaderTypeButtonItem, HeaderQuickSettingItem, HeaderNotificationContentItem } from "@/components";

const HeaderNotification = ({ forwardedRef }) => {
    const notificationQuickSettingButtonRef = useRef();
    ...
    return (
        <div ref={forwardedRef} className="absolute top-0 left-0 translate-x-[-172px] translate-y-[48px]">
                            ...
                            <div className="flex flex-col grow relative">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <h2>
                                                                        <span
                                                                            className="block text-[17px] text-black font-semibold break-words leading-5">
                                                                            <span
                                                                                className="overflow-x-hidden overflow-y-hidden relative ">Before</span>
                                                                        </span>
                                                                    </h2>
                                                                </div>
                                                            </div>
                                        ...
                                        <ul className="relative">
                                            {fakeNotificationData.map((value, index) => (
            ...
            <div ref={notificationQuickSettingButtonRef} >
                {showNotificationQuickSetting ? (
                    <div className="absolute top-0 left-0 translate-x-[-20px] translate-y-[60px] z-50">
                        <div className="relative mt-[15px] rounded-l-md rounded-b-md shadow-[rgba(0,_0,_0,_0.24)_4px_7px_50px_1px]">
                            ...
                            <svg height="12" viewBox="0 0 21 12" width="21" className="absolute right-0 bottom-[calc(100%-1)] scale-x-[-1] scale-y-[-1] translate-x-0 translate-y-[-143px]" fill="white">
