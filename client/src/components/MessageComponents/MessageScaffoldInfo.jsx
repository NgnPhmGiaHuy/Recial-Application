...
const MessageScaffoldInfo = () => {
    ...
    return (
        <div
            className="max-w-[380px] min-w-[250px] flex flex-col basis-1/3 border-l border-solid border-zinc-200 relative">
            <div className="flex flex-col flex-shrink grow basis-full relative">
                <div
                    className="mb-[16px] flex flex-col flex-shrink grow basis-full overflow-auto overscroll-x-contain relative">
