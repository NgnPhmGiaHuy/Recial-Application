...
const MessageScaffoldItemSourceDelete = ({ messageProps, handleShowScaffold }) => {
                ...
                <div className="min-h-screen flex flex-col grow items-stretch justify-center relative">
                    <div className="min-h-[500px] px-[8px] pt-[56px] flex items-start justify-center animate-slideInTop">
                        <div className="flex flex-col rounded-lg shadow-[0px_0px_0px_1px_rgb(140_140_140/0.2)] overflow-hidden bg-white relative">
                            <div ref={null} className="w-[650px] overflow-hidden relative">
                                    ...
                                    <div className="w-full min-h-[60px] flex items-center justify-between border-b border-solid border-zinc-300 relative">
                                        ...
                                        <div className="flex flex-col items-center justify-center relative">
                                            <span className="block text-[20px] text-black text-center font-bold break-words relative leading-6">
                                               Delete this message from all people?
                                            </span>
                                        </div>
                                        <div className="w-[36px] h-[36px] mx-[16px]">
                                            <div className="w-full h-full flex items-center justify-center rounded-full bg-zinc-100 hover:bg-zinc-200 cursor-pointer overflow-hidden relative transition-all" onClick={handleShowScaffold}>
                                                <i>
                                    ...
                                    <div className="w-full flex flex-col grow relative">
                                        <div className="p-[16px] flex flex-col flex-shrink-0 relative">
                                            <div className="flex flex-wrap flex-shrink-0 items-stretch justify-end gap-2 relative">
                                               ...
                                               <MessageScaffoldItemDeleteButton title="Delete" isColor={true} onClick={() => handleDeleteMessage(messageProps?._id, conservationProps?._id, handleShowScaffold)}/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
export default MessageScaffoldItemSourceDelete;