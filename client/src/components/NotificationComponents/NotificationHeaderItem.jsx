                        ...
                        <div className="ml-[8px]">
                            <div>
                                <div className="rounded-full">
                                    <div ref={notificationQuickSettingItemButtonRef} className="w-[36px] h-[36px] flex justify-center items-center text-gray-500 cursor-pointer rounded-full bg-white shadow-[0px_0px_0px_1px_rgb(140_140_140/0.2)] border border-solid border-gray-200 relative hover:bg-zinc-100 transition-all"
