...
const PostItemDelete = ({ postProps, postItemDeleteRef, handleDeletePostStatus, handleShowPostItemDelete }) => {
    const handleDeletePost = async (postId) => {
        try {
            const deletedPost = await deletePostData(postId);
            if (deletedPost && !deletedPost.error) {
                handleDeletePostStatus();
            }
        } catch (error) {
            throw error;
        }
                ...
                <div className="min-h-screen flex flex-col grow items-stretch justify-center relative">
                    <div className="min-h-[500px] px-[8px] pt-[56px] flex items-start justify-center">
                        <div className="flex flex-col rounded-lg shadow-[0px_0px_0px_1px_rgb(140_140_140/0.2)] overflow-x-hidden overflow-y-hidden bg-white relative">
                            <div ref={postItemDeleteRef} className="w-[500px] overflow-x-hidden overflow-y-hidden relative">
                                <div className="w-full h-full flex flex-col grow relative">
                                    <div className="w-full min-h-[60px] flex items-center justify-between border-b border-solid border-zinc-300 relative">
                                        ...
                                        <div className="w-[36px] h-[36px] mx-[16px]">
                                            <div className="w-full h-full flex items-center justify-center rounded-full bg-zinc-100 hover:bg-zinc-200 cursor-pointer overflow-hidden relative transition-all" onClick={handleShowPostItemDelete}>
                                                <i>
                                            ...
                                            <div className="flex flex-wrap flex-shrink-0 items-stretch justify-end relative">
                                                <div className="pr-[8px] flex flex-col flex-shrink-0 basis-0 relative">
                                                    <div className="w-full flex flex-col justify-center relative">
                                                        <div className="h-[36px] px-[12px] flex flex-row flex-shrink-0 items-center justify-center rounded-md hover:bg-zinc-100 cursor-pointer relative transition-all" onClick={handleShowPostItemDelete}>
                                                ...
                                                <div className="flex flex-col flex-shrink-0 basis-0 relative">
                                                    <div className="w-full flex flex-col justify-center relative">
                                                        <div className="h-[36px] px-[40px] flex flex-row flex-shrink-0 items-center justify-center rounded-md bg-lime-500 hover:bg-lime-700 cursor-pointer relative transition-all" onClick={() => handleDeletePost(postProps?.post?._id)}>
