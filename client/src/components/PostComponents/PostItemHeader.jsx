        ...
        <div ref={headerRef} className="mb-[12px] px-[16px] pt-[12px] flex flex-row items-start">
            <div className="flex flex-row flex-shrink grow items-center relative">
                <div className="mr-[8px] flex flex-col justify-center relative">
                    ...
                    {/*            <Image src={props.postProps.user.authorAvatar} alt={`${props.postProps.user.authorAvatar}-image`} fill={true} sizes="(max-width: 768px) 100vw" className="object-cover"/>*/}
                    {/*        </div>*/}
            ...
            <div className="flex flex-row flex-shrink-0 grow-0 items-center relative">
                <div className="w-[40px] h-[40px] mx-[4px] p-[8px] flex self-start rounded-full cursor-pointer relative hover:bg-zinc-200" onClick={handleState.handleShowPostItemQuickSetting}>
                ...
                <div className="w-[40px] h-[40px] mx-[4px] p-[8px] flex self-start rounded-full cursor-pointer relative hover:bg-zinc-200" onClick={handleState.handleShowPostItemDelete}>
                    <div className="w-full h-full inline-flex flex-row items-stretch ">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
