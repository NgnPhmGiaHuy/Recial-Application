            ...
            <div className="animate-float py-[5px] flex whitespace-nowrap rounded-full shadow-[0px_0px_0px_1px_rgb(140_140_140/0.2)] bg-white relative">
                <div className="flex flex-col flex-shrink-0 grow relative">
                    <div className="flex flex-row flex-nowrap items-stretch justify-between relative">
                        <div className="flex flex-col flex-shrink grow basis-0 relative" onClick={() => handleReactionData({ destinationId: props.postProps?.post?._id, handleState: handleState.handleShowPostReactionButton })}>
                        ...
                        <div className="flex flex-col flex-shrink grow basis-0 relative" onClick={() => handleReactionData({ reactionType: "Dislike", destinationId: props.postProps?.post?._id, handleState: handleState.handleShowPostReactionButton })}>
                            <div className="mx-[4px] flex flex-row flex-shrink-0 items-center basis-auto cursor-pointer relative">
                                <div className="w-[40px] h-[40px] rounded-full overflow-hidden relative transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 duration-150">
                        ...
                        <div className="flex flex-col flex-shrink grow basis-0 relative" onClick={() => handleReactionData({ reactionType: "Happiness", destinationId: props.postProps?.post?._id, handleState: handleState.handleShowPostReactionButton })}>
                            <div className="mx-[4px] flex flex-row flex-shrink-0 items-center basis-auto cursor-pointer relative">
                                <div className="w-[40px] h-[40px] rounded-full overflow-hidden relative transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 duration-150">
                        ...
                        <div className="flex flex-col flex-shrink grow basis-0 relative" onClick={() => handleReactionData({ reactionType: "Unhappiness", destinationId: props.postProps?.post?._id, handleState: handleState.handleShowPostReactionButton })}>
                            <div className="mx-[4px] flex flex-row flex-shrink-0 items-center basis-auto cursor-pointer relative">
                                <div className="w-[40px] h-[40px] rounded-full overflow-hidden relative transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 duration-150">
