    ...
    return (
        <div className="w-[calc(50%-4px)] mb-[8px] p-[16px] flex items-center rounded-md shadow-[0px_0px_0px_1px_rgb(140_140_140/0.2)]">
            ...
            <div className="pr-[16px] flex flex-col flex-grow relative">
                    ...
                    <a href="">
                        <span className="text-[17px] text-black text-left font-semibold break-words relative leading-5 hover:underline">
                            <span className="overflow-hidden text-ellipsis line-clamp-1 relative">
                                {userProps.username || userProps.group_name}
                            </span>
                        </span>
                    </a>
                </div>
                ...
                {userProps.members && userProps.members.length ? (
                    <div className="mt-[4px] flex flex-row items-center relative gap-3">
                        <div className="flex flex-row items-center relative gap-1 after:w-[2px] after:h-[2px] after:rounded-full after:bg-zinc-500 after:mr-[-8px]">
                            ...
                            <span className="text-[13px] text-zinc-500 text-left font-normal break-words relative leading-4">
                                <span className="overflow-hidden relative">
                                    {userProps.group_privacy === "Public" ? "Public group" : "Private groupd"}
                                </span>
                            </span>
                        </div>
                        <a href="">
                            <span className="text-[13px] text-zinc-500 text-left font-normal break-words relative leading-4 hover:underline">
                                <span className="overflow-hidden relative">
                                    {userProps.members.length} members
                                </span>
                            </span>
                        </a>
                    </div>
