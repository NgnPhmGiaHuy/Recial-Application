...
const UserProfileEditInput = ({ formData, handleFormChange }) => {
    return (
        <>
            <div>
                <UserProfileEditInputItem title="Username*" inputName="session_username" required={true}
                                          formData={formData.session_username} handleFormChange={handleFormChange}/>
            </div>
            <div>
                <UserProfileEditInputItem title="First name*" inputName="session_firstname" required={true}
            ...
            <div>
                <UserProfileEditInputItem title="Description" inputName="session_description" textarea={true}
