...
export const notificationTypeOfColor = {
    Page: {
        ...
        svgIcon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="sm:w-5 w-4 sm:h-5 h-4">
    ...
    Group: {
        ...
        svgIcon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                 stroke="currentColor" className="sm:w-5 w-4 sm:h-5 h-4">
...
export const headerNavigationItemList = [
    {
        navigationName: "home",
...
export const headerNotificationQuickSettingList = [
    {
        ...
        settingItemTitle: "Mark all as read",
        ...
        settingItemTitle: "Notification settings",
        hasSettingItemSwitchButton: false,
    }, {
        isSettingItemBreak: false,
        settingItemIcon: (
        ...
        settingItemTitle: "Open notification",
        hasSettingItemSwitchButton: false,
    },
]

export const headerNotificationQuickSettingItemList = [
    {
        isSettingItemBreak: false,
        settingItemIcon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
        ...
        settingItemTitle: "Remove this notification",
        hasSettingItemSwitchButton: false,
    }, {
        isSettingItemBreak: false,
        settingItemIcon: (
        ...
        settingItemTitle: "Report issue to Notifications Team",
        hasSettingItemSwitchButton: false,
    },
]

export const headerMessageQuickSettingList = [
    {
        ...
        settingItemTitle: "Incoming call sounds",
        hasSettingItemSwitchButton: true,
    }, {
        isSettingItemBreak: false,
        settingItemIcon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
        ...
        settingItemTitle: "Message sounds",
        hasSettingItemSwitchButton: true,
    }, {
        isSettingItemBreak: false,
        settingItemIcon: (
        ...
        settingItemTitle: "Pop-up new messages",
        hasSettingItemSwitchButton: true,
    }, {
        isSettingItemBreak: true,
    }, {
        ...
        settingItemTitle: "Message requests",
        hasSettingItemSwitchButton: false,
    }, {
        isSettingItemBreak: false,
        settingItemIcon: (
        ...
        settingItemTitle: "Archived chats",
        hasSettingItemSwitchButton: false,
    }, {
        isSettingItemBreak: false,
        settingItemIcon: (
        ...
        settingItemTitle: "Message delivery settings",
        hasSettingItemSwitchButton: false,
    }, {
        isSettingItemBreak: true,
    }, {
        ...
        settingItemTitle: "Block setting",
        hasSettingItemSwitchButton: false,
    },
]

export const headerMessageQuickSettingItemList = [
    {
        isSettingItemBreak: false,
        settingItemIcon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
        ...
        settingItemTitle: "Mark as unread",
        hasSettingItemSwitchButton: false,
    }, {
        isSettingItemBreak: false,
        settingItemIcon: (
        ...
        settingItemTitle: "Turn off notification",
        hasSettingItemSwitchButton: false,
    }, {
        isSettingItemBreak: false,
        settingItemIcon: (
        ...
        settingItemTitle: "Delete chat",
        hasSettingItemSwitchButton: false,
    },
]

export const headerPersonalAccountSettingItemList = [
    {
        settingItemIcon: (
        ...
        settingItemLink: "/settings/categories/account",
        settingItemTitle: "Settings & privacy",
        ...
        settingItemLink: "/settings/categories/profile-visibility",
        settingItemTitle: "Display & accessibility",
        hasSettingItemChevronRight: true,
    }, {
        settingItemIcon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        settingItemLink: "",
        settingItemTitle: "Give feedback",
