...
const videoDataService = require("../../services/videoService/videoDataService");
...
class VideoController {
    getVideoData = async (req, res) => {
        try {
            ...
            const { statusCode, headers, stream } = await videoDataService.getVideoData(videoId, range);
    ...
    getVideoInfoData = async (req, res) => {
        try {
            ...
            const formattedVideoData = await videoDataService.getFormattedVideoDataById(video_id);
    ...
    getVideoReactionData = async (req, res) => {
        try {
            ...
            const videoReactionData = await generalDataService.getReactionData(video_id);
